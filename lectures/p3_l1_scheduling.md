...
* [Scheduling Overview](#scheduling-overview)
    ...
    * [Preemptive Scheduling](#preemptive-scheduling-SJF-+-Preempt)
    * [Priority Scheduling](#preemptive-scheduling-priority)
    * [Priority Inversion](#priority-inversion)
    * [Round Robin Scheduling](#round-robin-scheduling)
* [Timesharing and Timeslices](#timesharing-and-timeslices)
    * [CPU bound timeslice](#cpu-bound-timeslice-length)
    * [I/O bound timeslice](#io-bound-timeslice-length)
* [Runqueue Data structure](#runqueue-data-structure)
* [Linux 0(1) Scheduler](#linux-01-scheduler)
* [Linux CFS Scheduler](#linux-cfs-schedulers)
* [Scheduling on Multiprocessors](#scheduling-on-multiprocessors)
* [Hyperthreading](#hyperthreading)
* [CPU bound or Memory Bound?](#cpu-bound-or-memory-bound)
* [Scheduling with Hardware Counters](#scheduling-with-hardware-counters-fedorova)
...
<img width="400" src="p3_l1_resources/visual_metaphor.png">
...
<img width="600" src="p3_l1_resources/scheduling_overview.png">
...
<img width="600" src="p3_l1_resources/fcfs_metrics.png">
...
<img width="600" src="p3_l1_resources/sjf_design.png">
...
<img width="600" src="p3_l1_resources/sjf_metrics.png">
...
<img width="600" src="p3_l1_resources/preemptive_scheduling.png">
...
<img width="600" src="p3_l1_resources/priority_preemptive.png">
...
<img width="600" src="p3_l1_resources/preemption_quiz.png">

### Priority Inversion

<img width="600" src="p3_l1_resources/priority_inversion.png">
...
<img width="600" src="p3_l1_resources/rr_io.png">
...
<img width="600" src="p3_l1_resources/rr_noio.png">
...
<img width="600" src="p3_l1_resources/rr_interleaving.png">
...
<img width="600" src="p3_l1_resources/time_slicing_metrics.png">
...
<img width="600" src="p3_l1_resources/cpu_bound.png">
...
<img width="600" src="p3_l1_resources/io_bound.png">

For IO bound tasks, in the scenario above, the two tasks are equivalent because of IO blocking. 

<img width="600" src="p3_l1_resources/io_bound2.png">
...
<img width="600" src="p3_l1_resources/timeslice_summary.png">
<img width="600" src="p3_l1_resources/timeslice_utilization.png">
...
<img width="600" src="p3_l1_resources/multi_queue.png">
...
<img width="600" src="p3_l1_resources/feedback_queue.png">
...
<img width="600" src="p3_l1_resources/linux_cfs.png">
...
<img width="600" src="p3_l1_resources/multi_cpu_architecture.png">
...
<img width="600" src="p3_l1_resources/numa_scheduling.png">
...
<img width="600" src="p3_l1_resources/hyperthreading.png">
...
<img width="600" src="p3_l1_resources/hyperthreading_assumptions.png">
...
<img width="600" src="p3_l1_resources/hyper_computebound.png">
...
<img width="600" src="p3_l1_resources/hyperthreading_membound.png">
...
<img width="600" src="p3_l1_resources/hyperthreading_mix.png">
...
<img width="600" src="p3_l1_resources/fedorova.png">
...
<img width="600" src="p3_l1_resources/fedorova2.png">
...
<img width="600" src="p3_l1_resources/fedorova3.png">